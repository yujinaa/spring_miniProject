...
const resultList=[
	...
	{	
		name : '호주',
		desc : '호주는 권력간 불평등이 낮은 사회로 관리자는 전문 지식을 위해 개별 직원과 팀에 의존합니다. 관리자와 직원 모두 정보를 자주 공유하고 동시에 커뮤니케이션은 직접적이며 참여적입니다. 그리고 매우 개인주의적인 문화이기 때문에 사람들은 자립적이고 주도권을 발휘할 것으로 기대됩니다.<br> 호주는 남성적 사회로 간주되는데 인생에서 자신의 성공과 업적을 자랑스럽게 여기며 직장에서의 고용 및 승진 결정의 기초를 제공합니다. <br> 또한 규범적인 문화를 가지고 있는데 그러한 사회의 사람들은 전통을 크게 존중하고 미래를 위해 저축하는 경향이 상대적으로 적으며 빠른 결과를 얻는 데 집중합니다. 또 다른 특징은 관대함에서 높은 점수로 분류된 사회인데 일반적으로 인생을 즐기고 즐기는 것과 관련하여 자신의 충동과 욕구를 실현하려는 의지를 나타냅니다. 그들은 긍정적인 태도를 가지고 있으며 낙관적인 경향이 있고 여가를 중시하는 경향이 있습니다.'
	},
	{	
		name : '뉴질랜드',
		desc : '뉴질랜드는 조직 내에서 계층 구조는 편의를 위해 설정되며, 관리자는 전문 지식을 위해 개별 직원과 팀에 의존합니다. 관리자와 직원 모두 정보를 자주 공유하는 동시에 대화 방식은 직접적이며 참여적인 특징을 가졌습니다. 그리고 개인주의 문화로 사람들은 자립적이고 주도권을 발휘할 것으로 기대됩니다.<br> 뉴질랜드는 남성적 사회로 간주되는데 인생에서 자신의 성공과 업적을 자랑스럽게 여기며 직장에서의 고용 및 승진 결정의 기초를 제공합니다. 갈등은 개인 차원에서 해결되고 목표는 승리하는 것이라는 생각이 강합니다. 또 다른 특징으로는 규범적인 국가로 나타났는데 그러한 사회의 사람들은 전통을 크게 존중하고 미래를 위해 저축하는 경향이 상대적으로 적으며 빠른 결과를 얻는 데 집중합니다.<br>마지막으로 관대함에서 높은 점수로 분류된 사회인데 뉴질랜드 사람들은 일반적으로 인생을 즐기고 즐기는 것과 관련하여 자신의 충동과 욕구를 실현하려는 의지를 나타내고 긍정적인 태도를 가지고 있으며 낙관적인 경향이 있습니다. 또한 여가를 중시하고 마음대로 행동하며 마음대로 돈을 쓰는 경향도 있습니다.'
		},
]