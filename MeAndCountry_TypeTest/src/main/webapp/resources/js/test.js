...
const resultList=[
	...
	{	
		name : '아르헨티나',
		desc : '아르헨티나는 권력간 불평등이 최소화 되야한다고 생각하는 것으로 최하위권에 있습니다. 낮은 점수를 받은 원인은 1900년경에 약 650만 명의 유럽 이민자들이 아르헨티나에 들어왔고 당시 주민의 30% 이상이 해외에서 태어났기 때문에 불평등을 용인하지 않는 사회라고 할 수 있습니다.'<br>
	},
	{	
		name : '이집트',
		desc : '어쩌구 저쩌구'
